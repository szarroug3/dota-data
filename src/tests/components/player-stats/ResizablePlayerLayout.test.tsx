...
import { ResizablePlayerLayout } from '@/components/player-stats/ResizablePlayerLayout';
import type { PlayerDetailsPanelMode } from '@/components/player-stats/details/PlayerDetailsPanel';
import type { PlayerListViewMode } from '@/components/player-stats/list/PlayerListView';
...
jest.mock('@/components/player-stats/list/PlayersList', () => ({
  PlayersList: ({
    players,
    selectedPlayerId,
    hiddenPlayersCount,
...
jest.mock('@/components/player-stats/details/PlayerDetailsPanel', () => ({
  PlayerDetailsPanel: ({
    player,
    viewMode,
    onViewModeChange,
