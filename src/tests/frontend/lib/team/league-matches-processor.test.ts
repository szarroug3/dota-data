/**
 * Tests for league matches processor
 */

import type { LeagueMatchesCache } from '@/frontend/lib/app-data/app-data-types';
import { getOrFetchLeagueMatches, processLeagueMatches } from '@/frontend/lib/team/league-matches-loader';
