...
describe('MatchListViewList', () => {
  ...
  it('handles long opponent names with truncation', () => {
    ...
    const teamMatches: Record<number, TeamMatchParticipation> = {
      ...
      101: { matchId: 101, duration: 3000, opponentName: 'Very Long Opponent Name That Should Be Truncated When It Exceeds The Available Space', leagueId: 'league-4', startTime: 1732233600, side: 'radiant', result: 'won', pickOrder: 'first' },
    };
