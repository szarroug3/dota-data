...
describe('cn utility function', () => {
  ...
  it('should handle mixed input types', () => {
    const isActive = true;
    const result = cn('base-class', ['class1', 'class2'], isActive && 'active', { conditional: true, hidden: false });
  ...
  it('should handle Tailwind classes correctly', () => {
    const result = cn('px-4 py-2', 'bg-blue-500 hover:bg-blue-600', 'text-white font-bold');
