...
describe('/api/cache/invalidate', () => {
  ...
  it('should return 400 for missing invalidation criteria', async () => {
    const request = new NextRequest('http://localhost:3000/api/cache/invalidate', { method: 'POST', body: JSON.stringify({}) });
    request.json = async () => ({});
  ...
  it('should return 400 for both pattern and key provided', async () => {
    const request = new NextRequest('http://localhost:3000/api/cache/invalidate', { method: 'POST', body: JSON.stringify({ pattern: 'foo', key: 'bar' }) });
  ...
  it('should invalidate by pattern (success)', async () => {
    ...
    const request = new NextRequest('http://localhost:3000/api/cache/invalidate', { method: 'POST', body: JSON.stringify({ pattern: 'foo*' }) });
  ...
  it('should handle pattern invalidation error', async () => {
    ...
    const request = new NextRequest('http://localhost:3000/api/cache/invalidate', { method: 'POST', body: JSON.stringify({ pattern: 'bad*' }) });
  ...
  it('should invalidate by key (success, key exists)', async () => {
    ...
    const request = new NextRequest('http://localhost:3000/api/cache/invalidate', { method: 'POST', body: JSON.stringify({ key: 'bar' }) });
