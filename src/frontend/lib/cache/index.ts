...
export function setCacheItemUsing<T>(storage: Pick<Storage, 'setItem'>, key: string, value: T, options: CacheOptions): void {
...
export function getCacheItemUsing<T>(storage: Pick<Storage, 'getItem' | 'removeItem'>, key: string, options: CacheOptions): T | null {
	try {
