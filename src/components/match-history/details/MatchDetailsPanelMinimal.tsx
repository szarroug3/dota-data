...
export const MatchDetailsPanelMinimal: React.FC<MatchDetailsPanelMinimalProps> = ({ match, className = '' }) => {
  if (!match) {
    return (
  ...
  return (
    <div className={`p-4 ${className}`}>
      ...
      <div className="text-sm text-muted-foreground">Minimal match info goes here...</div>
    </div>
  );
}; 