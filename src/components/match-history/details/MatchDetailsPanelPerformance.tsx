...
const MatchDetailsPanelPerformance: React.FC<MatchDetailsPanelPerformanceProps> = ({ match, teamMatch: _teamMatch, className }) => {
  if (!match) {
    return (
      <div className="text-center text-muted-foreground py-8">
...
export default MatchDetailsPanelPerformance; 